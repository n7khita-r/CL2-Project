...
def plot_confusion_matrix(y_true, y_pred, classes, save_path='news_confusion_matrix.png'):
...
def evaluate_classifier(y_true, y_pred, classes):
    ...
    for i, cls in enumerate(classes):
        print(f"{cls:<25} {precision[i]:<12.4f} {recall[i]:<12.4f} {f1[i]:<12.4f} {support[i]:<10.0f}")
    
    print("-"*90)
    print(f"{'Macro Average':<25} {precision_macro:<12.4f} {recall_macro:<12.4f} {f1_macro:<12.4f}")
    print(f"{'Micro Average':<25} {precision_micro:<12.4f} {recall_micro:<12.4f} {f1_micro:<12.4f}")
    print("="*90)
