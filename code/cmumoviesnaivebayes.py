...
# ============================================================================
def plot_confusion_matrix(y_true, y_pred, classes, save_path='../results/NaiveBayes/CMUMovies/confusion_matrix.png'):
...
def evaluate_classifier(y_true, y_pred, classes, save_path='../results/NaiveBayes/CMUMovies/evaluation_metrics.txt'):
...
def main():
    ...
    features_path = '../results/NaiveBayes/CMUMovies/top_features.txt'
    ...
    predictions_path = '../results/NaiveBayes/CMUMovies/predictions.csv'
    predictions_df.to_csv(predictions_path, index=False)
    print(f"✓ Predictions saved to: {predictions_path}")
    
    summary_path = '../results/NaiveBayes/CMUMovies/summary.txt'
    ...
    print("="*80)
    print(f"\n✓ All results saved to ../results/NaiveBayes/CMUMovies/")
